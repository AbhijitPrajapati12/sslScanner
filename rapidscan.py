...
def getParticularIndex(arr):
    ind = [1,2,3,4,5,7,16,17,18,19,20,21,22]
    res = []
    for i in ind:
        res.append(arr[i-1])
    return res
...
tool_status = getParticularIndex([
                #1
